...
<div style="border-bottom: 1px dotted slategray;width: 800px ; "><span style="color: #302d2d" >用户</span>:<span>${messages.username}</span>&nbsp; &nbsp;${messages.content}</div>
...
<input type="checkBox" value="是否匿名提交" name="checked">匿名提交 </input>
    <label><div style="color:red">操作:提交成功用户积分+20</div></label>
   </div> 
</form>
